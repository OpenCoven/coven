...
(including Claude Code) contributing to this repo — branch/PR workflow, local CI
gates, the Rust-authority invariants, and contributor attribution.
...
separate Claude-only workflow for this repo — follow `AGENTS.md`.
