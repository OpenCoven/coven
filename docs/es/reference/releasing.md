...
description: "Runbook para publicar Coven en npm: preflight, dry-run, paquetes nativos por plataforma y verificación postflight desde el workflow de GitHub Actions."
---
