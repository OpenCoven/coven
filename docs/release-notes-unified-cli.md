...
> 🎉 **Now available.** The unified `coven` CLI is live on npm — one install, one command, end to end.
>
> ```bash
...
- `coven --version` — shows the whole stack, e.g. `coven v0.1.1 (engine coven-code v0.7.0, pinned v0.7.0)`
