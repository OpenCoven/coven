...
> _"Приведи любого фамильяра в круг."_

<p align="center">
  <strong>OpenCoven — это открытая экосистема для постоянных AI-фамильяров. Coven — это локальная runtime-подложка, которая управляет каждым harness — Codex, Claude Code и будущими Hermes, Aider и Gemini CLI — внутри явных границ проекта.</strong><br />
...
<Columns>
  ...
  <Card title="Интеграция клиентов" icon="plug-zap" href="/CLIENT-INTEGRATION">
    comux, OpenMeow и мост OpenClaw интегрируются как socket-клиенты, а не как авторитеты запуска.
  </Card>
</Columns>
...
<Columns>
  ...
  <Card title="Локальный API" href="/API" icon="plug">
    Версионированный socket API для comux, OpenMeow, OpenClaw-плагина и твоих собственных клиентов.
  </Card>
