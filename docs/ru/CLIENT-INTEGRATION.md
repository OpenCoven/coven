...
description: "Как comux, OpenMeow, OpenClaw и другие клиенты должны разговаривать с socket API демона Coven, не дублируя политику или авторитет runtime."
---
...
## OpenMeow и поверхности приёма

Клиенты типа OpenMeow лучше всего рассматривать как слои приёма и представления.
